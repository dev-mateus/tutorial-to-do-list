...
Cada etapa detalhada esta em arquivos separados na pasta docs, seguindo o mesmo padrao didatico:
- Objetivo do passo
...
4. [Passo 4 - Hook com regras de negocio](docs/TUTORIAL_PASSO_4.md)
...
9. [Passo 9 - Estilizacao com CSS puro](docs/TUTORIAL_PASSO_9.md)
